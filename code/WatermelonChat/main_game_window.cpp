...
void MainGameWindow::paintEvent(QPaintEvent *event)
{
    ...
    QPixmap bmpBlocks(":/other/game/image/blocks.bmp");
    QPixmap bmpFaces(":/other/game/image/faces.bmp");
    QPixmap bmpFrame(":/other/game/image/frame.bmp");
    QPixmap bmpNumber(":/other/game/image/timenumber.bmp");
